...
Analysis code for the paper **"Engineering scarcity into vulnerability: desalination, water security, and the governance of conflict risk in the Gulf Cooperation Council"** (Ashkanani, Shuaibi and Albatayneh), submitted to *Journal of Hydrology*.
